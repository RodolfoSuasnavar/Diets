...
<!-- aqui -->
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../caloria/caloriadmin.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="caloria.php">Peso</a></li>
    ...
    <form action="#" method="post" id="frmbuscar">
     <tr class="espacio">
     <td align="right"> <label for="peso">Peso:</label></td><td><input type="text" class="form-control" name="peso" id="peso" autocomplete="off"></td>
    ...
    <?php
      ...
      $result = mysqli_query($link, "SELECT * FROM peso WHERE peso  like '$_POST[peso]%'");
      ...
      echo "<tr>               
          ...
          ?>
           <tr>
            <td class='active'><?php echo $peso ?></td>
            <td class='active'><?php echo $fecha ?></td>
 ...
 confirmar=confirm("\u00bfRealmente deseas eliminar el registro?"); 
    ...
    {
      document.location="pesoadmin.php";
    } 
    }
    </script>
