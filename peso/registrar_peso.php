...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="peso.php" class="logo d-flex align-items-center">
...
?>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      ?>
      <li class="nav-item">
        <a class="nav-link " href="registrar_peso.php">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../caloria/caloria.php">
              <i class="bi bi-circle"></i><span>Calorias</span>
            </a>
          </li>
          <li>
            <a href="../caloria/registrar_productos.php">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Peso</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div>
          <div class="col-md-6 offset-md-3">
              <div class="panel panel-primary">
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="peso">Peso:</label></td><td><input type="text" class="form-control" name="peso" id="peso" placeholder="Ingresa peso" pattern="[0-9]+" autofocus required ></td>
                      </tr> 
                      <br>
                      <tr class="espacio"> 
                      <tr class="espacio"> 
                      <td align="right"> <label for="datefecha">Fecha:</label></td><td><input type="date" class="form-control" name="fecha" id="fecha" placeholder="Ingresa fecha" required ></td>
                      </tr> 
                      <!-- <tr class="espacio"> 
                      <td align="right"> <label for="categoria">Categoria:</label></td><td><input type="text" class="form-control" name="categoria" id="categoria" placeholder="Ingresa la categoria" required></td>
                      </tr> 
                      <tr class="espacio"> 
