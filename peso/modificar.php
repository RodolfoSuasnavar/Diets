...
?>  
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="productos.php">peso</a></li>
...
<?php
                      require_once("../bd/conexion.php");
                      $opcion = $_GET['id'];
                      $result=mysqli_query($link,"SELECT * FROM peso WHERE id='$opcion'");
...
?>
          <div class="col-md-6 offset-md-3">
              <div class="panel panel-primary">
                      ...
                      <table width="100%">
                      <form action="modificar_peso.php" method="post" id="frmcliente" enctype="multipart/form-data">
                      <tr class="espacio"> 
                      <input autocomplete="off" type="hidden" class="form-control" name="id" id="id" value="<?php echo $consulta['id'];?>">
                      </tr> 
                      <tr class="espacio"> 
                      <td align="right"> <label for="peso">Peso:</label></td><td><input type="text" class="form-control" name="peso" id="peso" value="<?php echo $consulta['peso'];?>" autofocus required pattern="[0-9]+"></td>
                      </tr> 
                      <tr class="espacio"> 
                      <tr class="espacio"> 
                      <td align="right"> <label for="gramos">Fecha:</label></td><td><input type="text" class="form-control" name="fecha" id="fecha" value="<?php echo $consulta['fecha'];?>" required  readonly></td>
                      </tr> 
                      <!-- <tr class="espacio"> 
                      <td align="right"> <label for="carbohidratos">Carbohidratos:</label></td><td><input type="text" class="form-control" name="carbohidratos" id="carbohidratos" value="<?php echo $consulta['carbohidratos'];?>" required></td>
                      </tr>  -->
                      <!-- <tr class="espacio"> 
